...
function Head() {
  ...
  return (
    <>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Orbitron:wght@700;900&family=Anton&display=swap" rel="stylesheet" />
      <style>{`
