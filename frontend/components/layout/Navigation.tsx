...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <header className={`h-20 sm:h-24 flex items-center justify-between ${className}`}>
      {/* Logo on the left */}
      <a href={assetPath('/')} className="flex items-center rounded-xl px-1.5 sm:px-2 py-1 hover:bg-white/5 transition-colors">
        <img src={assetPath('/UI/kpifit-logo-nav.png')} alt="KPIFit" className="h-10 sm:h-12 w-auto" />
      </a>
